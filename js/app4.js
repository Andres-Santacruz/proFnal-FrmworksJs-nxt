$(function(){
  ...
  function moverObj() {
    ...
    function verifElemComp() {
      ...
      //console.log('la matriz que quedo: '+mtzd);
      return mtzd;
    }
  ...
  function validar() {
    ...
    for (var j = 1; j < 8; j++) {
      ...
      if (ch.length>2) {
        while (k<(ch.length-2)) {
          ...
          if (h1==h2 && h2==h3) {
          //  console.log('iguales V:  '+j+(k+1)+' '+j+(k+2)+' '+j+(k+3));
    ...
    for (var i = 1; i < 6; i++) {
      ...
      if (c1==c2 && c2==c3) {
        while (cl<=c1) {
          ...
          cl=cl+1;
          if (sr1==sr2 && sr2==sr3) {
            //console.log('son iguales H:  '+i+r+', '+(i+1)+r+', '+(i+2)+r);
      ...
      switch (ban) {
        ...
        while (cl<=c1) {
          ...
          cl=cl+1;
          if (sr1==sr2 && sr2==sr3) {
            //console.log('son iguales H:  '+i+r+', '+(i+1)+((c2-c1)+r)+', '+(i+2)+((c3-c1)+r));
            x1=''+i+r;
            x2=''+(i+1)+((c2-c1)+r);
            x3=''+(i+2)+((c3-c1)+r);
            vv=[parseFloat(x1),parseFloat(x2),parseFloat(x3)];
        ...
        while (cl<=c2) {
          ...
          cl=cl+1;
          if (sr1==sr2 && sr2==sr3) {
            //console.log('son iguales H:  '+i+((c1-c2)+r)+', '+(i+1)+r+', '+(i+2)+((c3-c2)+r));
            x1=''+i+((c1-c2)+r);
            x2=''+(i+1)+r;
            x3=''+(i+2)+((c3-c2)+r);
            vv=[parseFloat(x1),parseFloat(x2),parseFloat(x3)];
        ...
        while (cl<=c3) {
          ...
          cl=cl+1;
          if (sr1==sr2 && sr2==sr3) {
            //console.log('son iguales H:  '+i+((c1-c3)+r)+', '+(i+1)+((c2-c3)+r)+', '+(i+2)+r);
            x1=''+i+((c1-c3)+r);
            x2=''+(i+1)+((c2-c3)+r);
            x3=''+(i+2)+r;
            vv=[parseFloat(x1),parseFloat(x2),parseFloat(x3)];
    ...
    //console.log('Mtriz de valor a eliminar:  '+velim);
    return velim;
  }
  function animTit(){
